module.export = function (RED) {
    function bfvAdd(config) {
        ...
        node.on('input', function (msg) {
            ...
            const addCipherText = encryptor.encrypt(addPlainText);

            evaluator.add(cipherText, addCipherText, cipherText);

            msg.payload = cipherText;
            node.send(msg);
        });
    }
    RED.nodes.registerType('BFV-Add', bfvAdd);
};
