    ...
    function reciprocal(config) {
        ...
        node.on("input", function (msg) {
            ...
            try {
                ...
                const norEncryArray = evaluator.multiplyPlain(
                    cipherText,
                    plainNormailzerArray
                );
                ...
                const array1 = Float64Array.from(
                    { length: encoder.slotCount },
                    () => 1
                );
                ...
                evaluator.plainModSwitchTo(
                    oneNorEncrypt,
                    invNorEncryArray.parmsId,
                    oneNorEncrypt
                );

                const resultEncryArray = evaluator.multiplyPlain(
                    invNorEncryArray,
                    oneNorEncrypt
                );
